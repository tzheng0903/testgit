...
//		deploy("geely-test.bpmn");
//		ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("myProcess");
//		taskService.complete("392504");
//		runtimeService.deleteProcessInstance("332501", "");
...
//		ts.insertTasksBefore("manager_audit", "user_approve_1_A","user_approve_1_B");
		TaskFlowControlService tfs = tff.create("392501");
		tfs.insertTasksBefore("manager_audit", "user_approve_1_B","user_approve_2_B");
		System.out.println();
//		runtimeService.createProcessInstanceQuery().list().forEach(proins->{
//			runtimeService.deleteProcessInstance(proins.getId(), "ddd");
//		});;
	}
